	...
	<div class="container-fluid content-style">
		<div class="row">
			<div class="col-md-7 text-center" >
				<h3 style="color: blue;">Add Project</h3><br/>
			</div>
		</div>
		<form:form method="POST" action="add" modelAttribute="project">
			<div class="form-group">
				<div class="row">
					...
					<div class="col-md-4">
						<form:input class="form-control" name="projectId" path="projectId" id="projectId"
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-md-4">
						<form:input class="form-control" id="projectName" name="projectName"
							path="projectName" placeholder="Enter Project Name" />
					</div>
					<div class="col-md-5 has-error">
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-md-4">
						<form:input class="form-control" id="requesterID" name="requesterID" path="requesterID"
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-md-4">
						<form:input class="form-control" id="requesterName" name="requesterName" path="requesterName"
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-md-4">
						<form:input class="form-control" id="approverID" name="approverID" path="approverID"
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-md-4">
						<form:input class="form-control" id="approverName" name="approverName" path="approverName"
